import { ChillerExtraction, RainwaterExtraction, MaterialExtraction } from '../schemas/igbc-manifests';

export class IgbcScoreAuthority {
  static verifyChillerEfficiency(data: ChillerExtraction) {
  ...
  static verifyRainwaterHarvesting(data: RainwaterExtraction) {
  ...
  static verifyRecycledContentValue(data: MaterialExtraction) {
