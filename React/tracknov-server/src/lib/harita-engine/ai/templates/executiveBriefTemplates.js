...
exports.ExecutiveBriefTemplates = void 0;
class ExecutiveBriefTemplates {
    static formatBrief(brief, context) {
        return `
[EXECUTIVE BRIEF]
Context: ${context}
...
exports.ExecutiveBriefTemplates = ExecutiveBriefTemplates;
