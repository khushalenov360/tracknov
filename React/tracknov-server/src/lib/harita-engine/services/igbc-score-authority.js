...
exports.getAuthoritativeProjectScore = getAuthoritativeProjectScore;
function getAuthoritativeProjectScore(workspace) {
    return __awaiter(this, void 0, void 0, function* () {
        var _a;
        const credits = (_a = workspace.credits) !== null && _a !== void 0 ? _a : [];
        const earned = credits.filter((c) => c.status === "complete").length;
...
class IgbcScoreAuthority {
     ...
     */
    static verifyChillerEfficiency(data, projectContext) {
     ...
     */
    static verifyRainwaterHarvesting(data, projectContext) {
        ...
        const calculatedYieldLiters = ((data.impervious_roof_area_sqm * roofCoefficient) +
            (data.paved_area_sqm * pavingCoefficient)) * peakDailyRainfallMeters * 1000;
     ...
     */
    static verifyRecycledContentValue(materials, projectContext) {
        ...
        let pointsAwarded = 0;
        if (overallProjectRecycledPercentage >= 20)
            pointsAwarded = 2;
        else if (overallProjectRecycledPercentage >= 10)
            pointsAwarded = 1;
        return {
