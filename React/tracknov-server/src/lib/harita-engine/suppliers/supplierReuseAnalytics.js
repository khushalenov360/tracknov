...
exports.SupplierReuseAnalytics = void 0;
const supplierTrustEngine_1 = require("./supplierTrustEngine");
class SupplierReuseAnalytics {
    /**
     * Identifies highest trust suppliers matching selected green frameworks to limit audit friction
     */
    static getRecommendations(framework) {
        const list = this.mockSuppliers.map((sup) => {
            const scoring = supplierTrustEngine_1.SupplierTrustEngine.calculateTrustScore(sup);
            return {
...
exports.SupplierReuseAnalytics = SupplierReuseAnalytics;
SupplierReuseAnalytics.mockSuppliers = [
    {
        supplierId: "SUP-001",
