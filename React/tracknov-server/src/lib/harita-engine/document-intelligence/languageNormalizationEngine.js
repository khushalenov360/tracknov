...
exports.LanguageNormalizationEngine = void 0;
class LanguageNormalizationEngine {
    /**
     * Deterministically standardizes character set to standard clean UTF-8, replacing illegal codepoints.
     */
    static standardizeEncoding(text) {
        if (!text)
            return "";
...
exports.LanguageNormalizationEngine = LanguageNormalizationEngine;
