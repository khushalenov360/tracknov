...
exports.SustainabilityTermResolver = void 0;
class SustainabilityTermResolver {
    /**
     * Resolves raw rating or standard aliases to standardized framework constants.
     */
    static resolveTerm(term) {
        if (!term)
            return "UNKNOWN";
...
exports.SustainabilityTermResolver = SustainabilityTermResolver;
SustainabilityTermResolver.TERM_MAP = {
    "leed v4": "LEED_V4",
    "leed v4.1": "LEED_V4_1",
