...
export interface QualityAnalysisResult {
  ...
  qualityClass: "HIGH CONFIDENCE" | "MODERATE" | "LOW QUALITY";
...
export class DocumentQualityAnalyzer {
   ...
   */
  public static analyze(text: string, isScanned: boolean): QualityAnalysisResult {
    ...
    let qualityClass: "HIGH CONFIDENCE" | "MODERATE" | "LOW QUALITY" = "HIGH CONFIDENCE";
