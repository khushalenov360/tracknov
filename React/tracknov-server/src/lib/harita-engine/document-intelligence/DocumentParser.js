    ...
    parsePdf(buffer) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const { TableExtractionEngine } = yield Promise.resolve().then(() => __importStar(require("./tableExtractionEngine")));
    ...
    parseDocx(buffer) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const documentXml = yield ((_a = zip.file("word/document.xml")) === null || _a === void 0 ? void 0 : _a.async("string"));
                if (!documentXml) {
                    return { text: "", metadata: {}, tables: [] };
                }
