...
exports.ProcurementEvidenceMapper = void 0;
class ProcurementEvidenceMapper {
    /**
     * Generates documentation linkage candidates based on normalized bills
     */
    static generateLinkages(invoices) {
...
exports.ProcurementEvidenceMapper = ProcurementEvidenceMapper;
