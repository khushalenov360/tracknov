...
exports.QuestionClassifier = exports.QuestionType = void 0;
var QuestionType;
(function (QuestionType) {
    ...
    QuestionType["STATUS"] = "STATUS";
    QuestionType["RISK"] = "RISK";
    QuestionType["BLOCKER"] = "BLOCKER";
    QuestionType["RECOMMENDATION"] = "RECOMMENDATION";
    QuestionType["ACTION_REQUEST"] = "ACTION_REQUEST";
    QuestionType["IMPACT_ANALYSIS"] = "IMPACT_ANALYSIS";
    QuestionType["TRADEOFF"] = "TRADEOFF";
    QuestionType["STRATEGY"] = "STRATEGY";
    QuestionType["PROJECT_STATUS"] = "PROJECT_STATUS";
    QuestionType["PROJECT_RISK"] = "PROJECT_RISK";
    QuestionType["WORKLOAD"] = "WORKLOAD";
    QuestionType["EXECUTIVE_PRIORITY"] = "EXECUTIVE_PRIORITY";
    QuestionType["CERTIFICATION_GAP"] = "CERTIFICATION_GAP";
    QuestionType["EVIDENCE_PORTFOLIO"] = "EVIDENCE_PORTFOLIO";
    QuestionType["KNOWLEDGE_QUERY"] = "KNOWLEDGE_QUERY";
    QuestionType["SUBMISSION_READINESS"] = "SUBMISSION_READINESS";
    QuestionType["NARRATIVE_ASSISTANCE"] = "NARRATIVE_ASSISTANCE";
    QuestionType["CLARIFICATION_ASSISTANCE"] = "CLARIFICATION_ASSISTANCE";
    QuestionType["CONTRIBUTOR_COPILOT"] = "CONTRIBUTOR_COPILOT";
    QuestionType["GENERAL"] = "GENERAL";
    QuestionType["FILE_MAPPING_EXPLANATION"] = "FILE_MAPPING_EXPLANATION";
...
class QuestionClassifier {
    static classify(query) {
        ...
        if ((hasRoleEarly || q.includes("copilot") || (q.includes("what should") && q.includes("do today"))) &&
        ...
        if (q.includes("credits are") && (q.includes("blocked") || q.includes("ready") || q.includes("fail"))) {
            if (q.includes("blocked") || q.includes("fail"))
                return QuestionType.PROJECT_RISK;
        ...
        if ((q.includes("clarification") || q.includes("respond to") || q.includes("reply to") || q.includes("rejection")) &&
        ...
        if ((q.includes("upload") || q.includes("submit") || q.includes("assign") || q.includes("map") || q.includes("reassign")) &&
...
exports.QuestionClassifier = QuestionClassifier;
