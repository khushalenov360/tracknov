...
exports.RecommendationReasoner = void 0;
...
class RecommendationReasoner {
    static evaluate(query, runtimeContext, graphContext) {
        ...
        if (rejectedDocs.length > 0) {
            actions.push({
                priority: 90,
                action: `Review and resubmit the ${rejectedDocs.length} rejected document(s) (e.g. ${rejectedDocs.map((d) => d.file_name).join(', ')}).`,
        ...
        return {
            ...
            recommendations: explanation_engine_1.ExplanationEngine.explainRecommendation({ highestImpact: topAction.action })
        };
    }
}
exports.RecommendationReasoner = RecommendationReasoner;
