...
exports.ExtractionConfidenceAdjuster = void 0;
class ExtractionConfidenceAdjuster {
    /**
     * Calculates a recalibrated confidence score based on previous feedback trends.
     */
    static calculateRecalibratedConfidence(currentConfidence, totalCorrectionsCount, failureType) {
...
exports.ExtractionConfidenceAdjuster = ExtractionConfidenceAdjuster;
