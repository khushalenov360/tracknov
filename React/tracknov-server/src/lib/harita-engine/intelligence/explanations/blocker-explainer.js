...
exports.BlockerExplainer = void 0;
class BlockerExplainer {
    static explain(facts) {
        if ((facts === null || facts === void 0 ? void 0 : facts.missing) && facts.missing.length > 0) {
        ...
        if ((facts === null || facts === void 0 ? void 0 : facts.explicitBlockers) && facts.explicitBlockers.length > 0) {
...
exports.BlockerExplainer = BlockerExplainer;
