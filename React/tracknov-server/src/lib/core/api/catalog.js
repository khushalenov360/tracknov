...
exports.API_CATALOG = void 0;
exports.isEndpointPermittedForTier = isEndpointPermittedForTier;
exports.API_CATALOG = {
    // EnovAIT Layer
    assistant: {
        path: "/api/assistant",
 ...
 */
function isEndpointPermittedForTier(path, tier) {
    for (const key in exports.API_CATALOG) {
        const endpoint = exports.API_CATALOG[key];
