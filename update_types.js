const fs = require('fs');
const file = 'c:/Users/91922/Documents/Codex/tracknov/harita/lib/types.ts';
let lines = fs.readFileSync(file, 'utf-8').split('\n');

const replacement = `export type CreditStatus = import('./dtos').CreditStatus;
...
const newLines = [...lines.slice(0, 17), replacement, ...lines.slice(388)];
