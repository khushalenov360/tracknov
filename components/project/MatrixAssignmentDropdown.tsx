...
export const MatrixAssignmentDropdown: React.FC<MatrixAssignmentDropdownProps> = ({
  ...
  const [localAssigneeId, setLocalAssigneeId] = React.useState(currentAssigneeId);
  ...
  const handleChange = async (e: React.ChangeEvent<HTMLSelectElement>) => {
    ...
    try {
      ...
      setLocalAssigneeId(currentAssigneeId); // Revert on failure
    }
  };
