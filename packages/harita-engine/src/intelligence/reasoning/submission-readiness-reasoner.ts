...
export class SubmissionReadinessReasoner {
  public static async evaluate(
    ...
    if (!creditCode) {
      return {
        directAnswer: "Please specify a credit code (e.g. EDA C1) to assess submission readiness.",
    ...
    if (!parsedContent) {
      ...
      return {
        directAnswer: `No. There are no uploaded documents for ${creditCode} yet.`,
