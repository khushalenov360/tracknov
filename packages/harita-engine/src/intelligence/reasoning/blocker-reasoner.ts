  ...
  public static evaluate(query: string, runtimeContext: any, graphContext: any): ReasoningOutput {
    ...
    if (!creditMatch) {
      if (runtimeContext.project) {
        return {
          directAnswer: "I have analyzed the project context for blockers.",
      ...
      return {
        directAnswer: "I cannot determine which credit you are asking about.",
    ...
    const directAnswer = blockers.length > 0 
