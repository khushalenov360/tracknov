...
import { uploadDocumentAction, submitDocumentTransitionAction, joinProjectAction } from "@/app/actions";
            ...
            {selectedTask ? (
              ...
              <div className="flex-1 flex flex-col justify-between space-y-4">
                ...
                <div className="space-y-3 flex-1 text-left">
                  ...
                  <form action={joinProjectAction} className="p-3 bg-[var(--color-surface-2)] border border-[var(--color-border)] rounded-lg space-y-2">
                    <span className="text-[9px] uppercase font-black text-slate-500 block">Join Project with Code</span>
                    <div className="flex gap-2">
                      <input
                        type="text"
                        name="project_code"
                        placeholder="e.g. SFIL-BHAVARKUA"
                        required
                        className="flex-1 px-2.5 py-1.5 text-xs rounded border border-[var(--color-border)] bg-[var(--color-surface)] text-[var(--color-text-primary)] focus:outline-none focus:border-[var(--color-green)]"
                      />
                      <Button type="submit" className="h-7 px-3 bg-[var(--color-green)] text-white hover:bg-[var(--color-green-dim)] text-[11px] font-bold">
                        Join
                      </Button>
                    </div>
                  </form>
